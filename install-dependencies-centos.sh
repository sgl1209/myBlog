...
# CentOS/Alibaba Cloud Linux 依赖安装脚本
# 在服务器上运行：bash install-dependencies-centos.sh

set -e

echo "🚀 开始安装服务器依赖（CentOS/Alibaba Cloud Linux）..."
echo ""
...
if ! command -v nginx &> /dev/null; then
    ...
    echo "✅ Nginx 已安装: $(nginx -v 2>&1 | head -n1)"
fi
echo ""
